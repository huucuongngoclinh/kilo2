...
neutron subnet-create ext-net 192.168.204.0/24 --name ext-subnet --allocation-pool start=192.168.204.101,end=192.168.204.200 --disable-dhcp --gateway 192.168.204.2
